...
(function() {
  ...
  write = function(source, sections, config) {
    var destination, fileLabel, hasTitle, html, title;
    destination = function(file) {
      ...
      */
      ...
      return path.join(config.output, "" + subPath + ".html");
    };
    fileLabel = function(file) {
      return file.substr(config.basePath.length);
      /*
  ...
  configure = function(options) {
    ...
    config.basePath = fs.realpathSync(options.basePath || process.cwd());
    if (!config.basePath.match(new RegExp("\\" + path.sep + "$"))) {
